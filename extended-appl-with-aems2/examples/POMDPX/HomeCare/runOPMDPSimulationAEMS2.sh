...
OUTPUT=out_AEMS2.policy
GRAPH=graph_AEMS2.dot
OUTPUT_OP=simOUT_AEMS2.txt
PLOT=performance_AEMS2.png
...
do
	...
	do
		...
		$SIMULATOR_PATH/pomdpOnlineSol $MODEL --budget 250 --simLen 30 --simNum $j --output $OUTPUT_OP --solverOP 2 --UnObsInitStateFile $INPUT
	done
...
FILEIN=simulationResults_AEMS2.txt
