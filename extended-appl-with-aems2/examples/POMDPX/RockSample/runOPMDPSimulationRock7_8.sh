...
OUTPUT=out_OP_RS.policy
GRAPH=graph_OP_RS.dot
OUTPUT_OP=simOUT_OP_RS.txt
...
do
	...
	do
		...
		$SIMULATOR_PATH/pomdpOnlineSol $MODEL --budget 250 --simLen 100 --simNum $j --output $OUTPUT_OP --solverOP 2 --UnObsInitStateFile $INPUT
	done
