...
namespace momdp{
	...
	/*		// 2X declaration of dtructure, it can be found in SampleBP PE::17.3.15
			// moved to momdp to solve visibility and 2x declaration issue
	...
	*/
    ...
    class SampleBPOP: public Sample{
	private:
	    //attributes
	...
	public:
	    ...
	    //constructor
	    SampleBPOP();
	    virtual void setup(SharedPointer<MOMDP> _problem, OPMDP* _solver);
