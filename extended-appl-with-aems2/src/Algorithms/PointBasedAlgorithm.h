...
namespace momdp 
{
	...
	public:
		...
		// added for OPMDP algorithm so it returns the oprimal action aftercalling solve	PAEL
		virtual int getOptimalAction(SharedPointer<MOMDP> problem, int action, int observation, int Xn) = 0;
