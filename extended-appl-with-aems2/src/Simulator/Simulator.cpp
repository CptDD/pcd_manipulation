...
//
//	Original Copyright (c) 2008-2010 by National University of Singapore.
...
int main(int argc, char **argv) 
{
   ...
   cout << "\nInitial UnObs state loaded... " << endl;
   cout	<< " input file	: " << p->initialUnObsState_file<< endl;
        }
        else
        {
        	p->initialUnObsState_val = -1;  // meaning that no initial state is given for unobservable St var-s
        }
