...
int main(int argc, char **argv) 
{
	...
	//try
	{
		...
		const int S_TREETEST = 15;		// add for tree testing PAEL::16.3.15

		// this section only for selectiong OP version in testing phase		PAEL
		cout << "if OP version needed enter 1  ";
		int OpVersionCheck = 0;
		//cin >> OpVersionCheck;
		if (1 == OpVersionCheck)
			p->strategy = S_TREETEST;
		...
		cout << "========= Execution time for alpha vector calcualtion: "<< Tend-Tbegin << endl;
