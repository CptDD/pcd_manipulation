...
#define CB_INITIALIZATION_PRECISION_FACTOR (1e-2)
	...
	struct nodeDepth_parent			// unique ID for depth and parent pointer PAEL 23.3.15
	{
		int		depth;
	...
	public:
		...
		nodeDepth_parent depthParentIndex;		// addad for POMDP phase 2&3 unique depth value for each node in the tree PAEL 23.03.15
