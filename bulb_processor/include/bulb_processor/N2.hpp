...
public:
  ...
  static std::string search(pcl::PointCloud<pcl::VFHSignature308>::Ptr cloud)
  {
    int k = 4;
    ...
    std::string kdtree_idx_file_name="/home/cptd/go_ws/src/bulb_processor/model/kdtree.idx";
    std::string training_data_h5_file_name="/home/cptd/go_ws/src/bulb_processor/model/training_data.h5";
    std::string training_data_list_file_name="/home/cptd/go_ws/src/bulb_processor/model/training_data.list";
    ...
    for (int i = 0; i < k; ++i)
    {
       ...
       //cout<<models.at (k_indices[0][i]).first.c_str ()<<" "<<k_indices[0][i]<<" "<<k_distances[0][i]<<endl;
    }


    return models.at(k_indices[0][0]).first.c_str();
  }
