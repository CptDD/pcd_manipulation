...
bool DSPOMDP::Step_IG(State& state, double random_num, int action,
	double& reward,OBS_TYPE& obs,Belief* b) const {
		
	return Step_IG(state, random_num, action, reward, obs,b);
}
